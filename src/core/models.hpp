...
struct VectorArrowModel : Model
{
    ...
    void update(glm::vec3 _pos = glm::vec3(0.0f), glm::vec3 _faceDirection = glm::vec3(0.0f),
    ...
    {
        renderableInfos = std::vector<RenderableInfo>{
            RenderableInfo{"head", "pyramid", "cube", glm::translate(glm::mat4(1.0f), pos)}};
    }
};
...
struct ParticleModel : Model
{
    ...
    {
        renderableInfos = {RenderableInfo{"particleBody", "cube", "cube", glm::translate(glm::mat4(1.0f), pos)}};
    }
};
...
struct AxesModel : Model
{
    ...
    {
        renderableInfos =
            std::vector<RenderableInfo>{RenderableInfo{"xAxis", "xAxis", "line", glm::translate(glm::mat4(1.0f), pos)},
                                        RenderableInfo{"yAxis", "yAxis", "line", glm::translate(glm::mat4(1.0f), pos)},
                                        RenderableInfo{"zAxis", "zAxis", "line", glm::translate(glm::mat4(1.0f), pos)}};
    }
};
